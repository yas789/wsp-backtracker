...
public class WSPBacktrackingTest {
    ...
    public void testBacktracking_NoValidAssignment() {
        ...
        // Add constraints:
        // - Step 0 and Step 1 must be assigned to different users (RED constraint).
        // - Step 0 and Step 2 must be assigned to different users (RED constraint).
        // - Step 1 and Step 2 must be assigned to the same user (BLACK constraint).
        // This creates a conflict that makes the problem unsolvable.
